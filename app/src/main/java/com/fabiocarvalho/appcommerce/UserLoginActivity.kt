...
class UserLoginActivity: AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnUserLogin.text = getString(R.string.user_login_title)
    ...
    private fun buildResetPasswordDialog(){
        ...
        dialogResetPassword = MaterialAlertDialogBuilder(this)
            .setPositiveButton("Resetar") { dialog, wich ->
                userViewModel.resetPassword(etEmail.text.toString())
                Toast.makeText(this, "Verifique seu e-mail para resetar a senha.", Toast.LENGTH_LONG).show()
                etEmail.text?.clear()
            }
            ...
            .setView(view)
            .setTitle("Preencha se e-mail para resetar a senha.")
            .create()
    }
