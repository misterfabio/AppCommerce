...
class UserProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnUserUpdate = findViewById(R.id.btn_user_profile)
    ...
    fun update() {
        ...
        userWithAddress.apply {
            ...
            if (addresses.isEmpty()) {
                ...
                addresses.first().apply {
                    ...
                    zipCode = userAddressCep.text.toString()
                    state =
                        resources.getStringArray(R.array.states)[userAddressState.selectedItemPosition]
                }
            }
        ...
        Toast.makeText(this, getString(R.string.user_profile_msg_success), Toast.LENGTH_SHORT)
            .show()
    }
